...
class sistemaPlanetario:
	...
	def __init__(self):
		self.__numPla = 4
		self.__planetas = []
		self.__planetas.append(Planeta('a', 450, 350, 2.5, -2.5, 200))
		self.__planetas.append(Planeta('b', 950, 350, 0,  0, 20000))
		self.__planetas.append(Planeta('c', 600, 100, 7,   0, 100))
		self.__planetas.append(Planeta('d', 90, 30, 0,   2, 10))
